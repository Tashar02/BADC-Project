...
public class U7G8_AdmitCardListController {
    ...
    public void viewAdmitCardOA(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(BADCApplication.class.getResource("rhythm/U7G8_AdmitCardDisplayView.fxml"));
            Scene scene = new Scene(loader.load());
            U7G8_AdmitCardDisplayController controller = loader.getController();
